            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-12 relative z-10">
                <div className="w-full max-w-[400px] space-y-8">
                    ...
                    <div className="flex flex-col space-y-2 text-center lg:text-left">
                        ...
                        <h2 className="text-3xl font-semibold tracking-tight">Crie sua conta</h2>
                    ...
                    <p className="text-center text-sm text-muted-foreground pt-4">
                        Já tem uma conta?{" "}
                        <Link href="/auth/login" className="font-semibold text-sky-500 hover:text-sky-600 hover:underline transition-colors">
                            Fazer login
                        </Link>
                    </p>
                </div>
                ...
                <div className="relative z-10 p-12 max-w-lg text-center backdrop-blur-sm bg-black/10 rounded-2xl border border-white/5 shadow-2xl">
                    ...
                    >
                        ...
                        <p className="text-lg text-white/60 leading-relaxed">
                            Crie sua conta em segundos e tenha acesso imediato aos templates e ferramentas de aceleração.
                        </p>
                    </motion.div>
                </div>
            </div>
